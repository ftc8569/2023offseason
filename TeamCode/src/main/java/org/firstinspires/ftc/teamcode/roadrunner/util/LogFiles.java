...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = JuicyMecanumDrive.TRANSLATIONAL_PID.kP;
        public double mecTransI = JuicyMecanumDrive.TRANSLATIONAL_PID.kI;
        public double mecTransD = JuicyMecanumDrive.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = JuicyMecanumDrive.HEADING_PID.kP;
        public double mecHeadingI = JuicyMecanumDrive.HEADING_PID.kI;
        public double mecHeadingD = JuicyMecanumDrive.HEADING_PID.kD;
        public double mecLateralMultiplier = JuicyMecanumDrive.LATERAL_MULTIPLIER;
